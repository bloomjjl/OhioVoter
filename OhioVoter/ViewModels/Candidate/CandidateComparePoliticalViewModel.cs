...
namespace OhioVoter.ViewModels.Candidate
{
    public class CandidateComparePoliticalViewModel
    {
        ...
        public CandidateComparePoliticalFirstViewModel CandidateComparePoliticalFirstViewModel { get; set; }
        public CandidateComparePoliticalSecondViewModel CandidateComparePoliticalSecondViewModel { get; set; }
    }
}